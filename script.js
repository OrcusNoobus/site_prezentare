...
function updateLanguage(lang) {
  ...
  document.getElementById('label-privacy-check').textContent = translations[lang].privacyCheckLabel;
...
contactForm.addEventListener('submit', async (e) => {
  ...
  if (!privacyCheck.checked) {
    ...
    errorMsg.textContent = translations[currentLang].privacyCheckError;
